...
class User:
    ...
    def save(cls, formulario):
        ...
        result = connectToMySQL('muro_privado').query_db(query, formulario) #me regresan el nuevo ID de la persona registrada
        #result = 5
        return result
    ...
    def get_all(cls):
        ...
        users = []
        for us in results:
            #us = {id: 1, first_name: elena, last_name: de troya........}
            users.append(cls(us)) #1.- cls(result) creando una instancia de User. 2.- Esa instancia la agrego a la lista de users
